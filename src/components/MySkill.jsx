...
const MySkill = () => {
  return (
    <section
      id="skill"
      className=" px-5 md:px-12 bg-gradient-to-b from-[#0c0c1d] to-[#111132]"
    >
      <div className="py-20">
        <div className="flex gap-3 items-start">
          ...
          <span className="text-white">
            {" "}
            I am comfortable with this technology&apos;s{" "}
            <br className="hidden lg:block" />
            <span>
              Committed to learning new technologies and staying up-to-date in
              my field.
            </span>
          </span>
        </div>
